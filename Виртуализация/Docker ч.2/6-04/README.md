...
Ответ: Docker compose это интрумент оптимизации времени и ресурсов при поднятии микросервисов, которые состоят не только из одного контейнера. Благодаря ему можно задать декларативную структуру требуемых контейнеров с необходимыми настройками при поднятии.
