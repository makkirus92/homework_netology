...
Ответ: Docker compose это инcтрумент оптимизации времени и ресурсов при поднятии групп микросервисов, которые состоят не только из одного контейнера. Благодаря ему можно задать декларативную структуру требуемых контейнеров с необходимыми настройками при поднятии.
